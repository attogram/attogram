<?php // Attogram Framework - Navbar v0.2.1
...
if (class_exists('\attogram\AttogramUser')) {
    if (\Attogram\AttogramUser::isLoggedIn()) {
        echo '<li><a href="'.$this->path.'/user/"><span class="icon-s">👤</span> <b>'
            .((isset($_SESSION['AttogramUsername']) && $_SESSION['AttogramUsername'])
                ? $_SESSION['AttogramUsername']
                : 'user'
            ).'</b></a></li>'
            .'<li><a href="?logoff"><span class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span>'
            .' logoff</a></li>';
    } else {
